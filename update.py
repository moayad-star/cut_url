...
try:
    try:
        test_connect = str(requests.get("http://www.github.com/moayad-star/cut_url"))
    ...
    system("apt upgrade -y ; cd .. ; rm -rif cut_url ; git clone https://github.com/moayad-star/cut_url.git")
